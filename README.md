...
- python manage.py add_catalog - добавление первичных продуктов в каталог товаров
- python manage.py add_blog - добавление первичных статей в блог магазина
- python manage.py createadmin - создание суперпользователя (логин: `admin@mail.ru`, пароль: `asd1234zxc`)
